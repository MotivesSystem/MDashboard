...
const filters = [
    ...
    { label: "Supplier", type: "enum", fieldName: "suppliers", apiUrl: "/api/masterdata/get-supplier-master-data" },
                    ...
                    return (
                        <Grid item sm={1.6} key={filter.label}>
                            <Autocomplete
                                ...
                                onChange={(e, newValue) => {
                                    const valueObj = {}
                                    valueObj[filter.fieldName] = `${newValue?.Id || ""}`
                                    setFieldData(field => {
